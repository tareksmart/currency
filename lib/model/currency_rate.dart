class CurrencyRate {
  ...
  CurrencyRate({this.date, this.base, this.rates});
...
class Rates {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['KMF'] = this.kMF;
    data['SHIB_m'] = this.sHIBM;
    data['MATH'] = this.mATH;
    data['IDEX'] = this.iDEX;
    data['MATIC_e'] = this.mATICE;
    data['GEL'] = this.gEL;
    data['AVAX'] = this.aVAX;
    data['AZN'] = this.aZN;
    data['UAH'] = this.uAH;
